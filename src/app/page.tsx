...
export default function HyperPortalLanding() {
    ...
    return (
        <div
            ...
            <motion.header className="mb-8 flex flex-col items-center" initial={{ opacity: 0, y: -80 }} animate={{
                opacity: 1,
                y: 0
            }} transition={{ duration: 0.9, type: "spring" }}>
                <motion.div className="relative" whileHover={{ scale: 1.1, rotate: 5 }} transition={{
                    type: "spring",
                    stiffness: 300
                }}>
            ...
            <motion.section id="portal-network" className="max-w-6xl mb-12" initial={{ opacity: 0, y: 60 }} animate={{
                opacity:
                    1, y: 0
                ...
                {showVoiceGreeting && (
                    ...
                    >
                        <motion.div className="bg-gradient-to-br from-[#222C52] to-[#191927] p-8 rounded-3xl max-w-md text-center"
                            initial={{ scale: 0.5, opacity: 0 }} animate={{ scale: 1, opacity: 1 }} exit={{
                                scale: 0.5, opacity: 0
